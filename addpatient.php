        ...
        <div class="navbar-right">
          ...
          <div id="navbar-menu">
            <ul class="nav navbar-nav">
              ...
              <li>
                <div class="dropdown">
                  <img src="assets/new/images/sm/avatar2.jpg" class="rounded-circle square-image" alt="profile-image"
                        ...
                        <div class="body">
                          ...
                          <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                              ...
                              <div class="col-sm-4">
                                <div class="input-group">
                                  <input type="text" data-date-autoclose="true" class="form-control" placeholder="Mobile">
                                </div>
                              </div>
                              <div class="col-sm-4">
                                <div class="input-group">
