    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="assets/new/images/user.png" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span>Welcome,</span>
                ...
                <div class="tab-pane p-l-15 p-r-15" id="Chat">
                    ...
                    <ul class="right_chat list-unstyled">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="assets/new/images/xs/avatar4.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="assets/new/images/xs/avatar5.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="assets/new/images/xs/avatar2.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="assets/new/images/xs/avatar1.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="assets/new/images/xs/avatar3.jpg" alt="">
                                    <div class="media-body">
            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Form Wizard</h2>
                        <ul class="breadcrumb">
...
<script src="assets/new/vendor/jquery-validation/jquery.validate.js"></script> <!-- Jquery Validation Plugin Css -->
<script src="assets/new/vendor/jquery-steps/jquery.steps.js"></script> <!-- JQuery Steps Plugin Js -->
...
<!-- Mirrored from www.wrraptheme.com/templates/lucid/hospital/light/forms-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 08:15:49 GMT -->
</html>
