...
<head>
    ...
    <meta name="description" content="Medx Bootstrap 4.1.1 Admin Template">
    ...
    <link rel="stylesheet" href="assets/new/vendor/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="assets/new/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
    <link rel="stylesheet" href="assets/new/vendor/toastr/toastr.min.css">
...
<body class="theme-cyan">
        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-right">
                    ...
                    <div id="navbar-menu">
                        <ul class="nav nav-tabs-new2 mt-2">                                
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#activity">Medical Tourism</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#billings">Geriatric Care</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#ivr">IVR</a></li>
                        </ul> 
            ...
            <div class="container-fluid">
                <div class="block-header">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane active" id="ivr">
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-12">
                                    <div class="row clearfix">
                                        <div class="col-lg-12 col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        ...
                                        <div class="m-l-35 m-b-30">
                                            ...
                                            <ul class="list-unstyled team-info">
                                                <li><img src="assets/new/images/xs/avatar1.jpg" data-toggle="tooltip"
                                                        data-placement="top" title="Dr. Chris Fox" alt="Avatar"></li>
                                                <li><img src="assets/new/images/xs/avatar2.jpg" data-toggle="tooltip"
                                                        data-placement="top" title="Dr. Joge Lucky" alt="Avatar"></li>
                                                <li><img src="assets/new/images/xs/avatar5.jpg" data-toggle="tooltip"
                                    ...
                                    <li>
                                        ...
                                        <div class="m-l-35">
                                            <small class="text-muted">SCHEDULED FOR 4:30 P.M. ON JUN 2018</small>
                                            <ul class="list-unstyled team-info">
                                                <li><img src="assets/new/images/xs/avatar4.jpg" data-toggle="tooltip"
                                                        data-placement="top" title="Dr. Chris Fox" alt="Avatar"></li>
                                                <li><img src="assets/new/images/xs/avatar6.jpg" data-toggle="tooltip"
                                                        data-placement="top" title="Dr. Joge Lucky" alt="Avatar"></li>
                                            </ul>
                                        </div>
                                    </li>
                                        ...
                                        <div class="cwidget-scroll">
                                            <ul class="chat-widget m-r-5 clearfix">
                                                <li class="left float-left">
                                                    <img src="assets/new/images/xs/avatar2.jpg" class="rounded-circle"
                                                        alt="">
                                                    <div class="chat-info">
                                                ...
                                                <li class="right">
                                                    <img src="assets/new/images/xs/avatar1.jpg" class="rounded-circle"
                                                        alt="">
                                                    <div class="chat-info">
                                ...
                                <div class="timeline-item blue">
                                    ...
                                    <div class="msg">
                                        ...
                                        <div class="timeline_img m-b-20">
                                            <img class="w-25" src="assets/new/images/blog/blog-page-4.jpg"
                                                alt="Awesome Image">
                                            <img class="w-25" src="assets/new/images/blog/blog-page-2.jpg"
                                                alt="Awesome Image">
                                        </div>
                                        <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
                                ...
                                <div class="table-responsive table_middel">
                                    <table class="table m-b-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td><img src="assets/new/images/xs/avatar3.jpg"
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td><img src="assets/new/images/xs/avatar1.jpg"
                                                        class="rounded-circle width30 m-r-15"
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td><img src="assets/new/images/xs/avatar4.jpg"
                                                        class="rounded-circle width30 m-r-15"
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td><img src="assets/new/images/xs/avatar2.jpg"
                                                        class="rounded-circle width30 m-r-15"
                                                        alt="profile-image"><span>Jack Bird</span></td>
                                            ...
                                            <tr>
                                                <td>5</td>
                                                <td><img src="assets/new/images/xs/avatar5.jpg"
                                                        class="rounded-circle width30 m-r-15"
    ...
    <script src="assets/new/vendor/toastr/toastr.js"></script>
    <script src="assets/new/vendor/flot-charts/jquery.flot.selection.js"></script>

    <script src="assets/bundles/mainscripts.bundle.js"></script>
    <script src="assets/js/index.js"></script>
</body>

<!-- Mirrored from www.wrraptheme.com/templates/Medx/hospital/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 08:15:17 GMT -->
