...
<body class="theme-cyan">
	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main" style="">
				<div class="auth-box">
                    <div class="top">
                        <img src="assets/img/logo.png" alt="Lucid">
                    </div>
					<div class="card">
                        <div class="header">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="dashboard.php">
                                ...
                                <div class="bottom">
                                    <span class="helper-text m-b-10"><i class="fa fa-lock"></i> <a href="forgot-password.html">Forgot password?</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
